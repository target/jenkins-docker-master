...
### Modify the image to company specific settings
  ...
  ```dockerfile
  FROM target/jenkins-docker-master:2.89.2-1
...
### Create the Docker Swarm service
  ...
  target/jenkins-docker-master:2.89.2-1
  ```
...
### `jenkins-docker-master:2.89.2-1`
...
### `jenkins-docker-master:debug-2.89.2-1`

This image is based off of the `jenkins-docker-master:2.89.2-1` image. The noticeable difference is in relation to increasing log verbosity for troubleshooting.
