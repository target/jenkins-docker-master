...
### Modify the image to company specific settings
  ...
  ```dockerfile
  FROM target/jenkins-docker-master:2.89.3-2
...
### Create the Docker Swarm service
  ...
  target/jenkins-docker-master:2.89.3-2
  ```
...
### `jenkins-docker-master:2.89.3-2`
...
### `jenkins-docker-master:debug-2.89.3-2`

This image is based off of the `jenkins-docker-master:2.89.3-2` image. The noticeable difference is in relation to increasing log verbosity for troubleshooting.
